  ...
  return (
    <View style={styles.wrapper}>
      <View style={styles.container}>
        <Pressable style={styles.navBtn}><Text style={styles.icon}>🏠</Text></Pressable>
        <Pressable style={styles.navBtn}><Text style={styles.icon}>📈</Text></Pressable>
        <View style={styles.spacer} />
        <Pressable style={styles.navBtn}><Text style={styles.icon}>⚡️</Text></Pressable>
        <Pressable style={styles.navBtn}><Text style={styles.icon}>👤</Text></Pressable>
      </View>
